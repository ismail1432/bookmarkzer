...
- Change host "bookmarkland.docker" in site.conf
- Change "skeleton" in .bashrc
- Change base url "https://bookmarkland.docker" in behat.yml.dist
- Change database name "skeleton" in .env
- Change dump name "skeleton.sql" in FixtureContext
- Change local domain "https://bookmarkland.docker" in ErrorHandlerContext.php
- Change urls which finish with "bookmarkland.docker" in docker-compose.override.yaml.dist
- Change urls which finish with "bookmarkland.docker" in docker-compose.yaml
